...
<section class="mx-auto py-16">
  <div class="mx-auto flex w-full flex-col items-center justify-center sm:max-w-screen-sm md:max-w-screen-md lg:flex-row">
    <div class="text-center">
        <h2 class="bg-clip-text text-3xl font-extrabold text-gray-700 sm:text-5xl">Casse Youth</h2>
        <p class="bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-4xl font-extrabold text-transparent sm:text-6xl">Tentang Kami</p>
